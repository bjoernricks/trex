...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, email, first_name=None, last_name=None,
    ...
    def create_user(self, email, first_name=None, last_name=None, password=None,
        ...
        return self._create_user(
            ...
            password=password, is_active=is_active, is_superuser=False)

    def create_superuser(self, email, first_name=None, last_name=None,
                         password=None, is_active=True):
        return self._create_user(
            email, first_name=first_name, last_name=last_name,
            password=password, is_active=is_active, is_superuser=True)
